...
public class Charizard extends Charmeleon implements FlyingType {
   ...
   /** Chooses type for fast attacks.*/
   protected boolean fastIsFire = true;
   /** Chooses type for special attack.*/
   ...
   */
   public String performFastAttack(Pokemon victim) {
      ...
      if (fastIsFire) {
         ...
         } else if (vType.equals("Fire") || vType.equals("Rock") 
                    || vType.equals("Dragon") || vType.equals("Water")) { 
